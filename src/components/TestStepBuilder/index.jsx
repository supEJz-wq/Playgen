...
export default function TestStepBuilder({ steps, setSteps }) {
  ...
  const addStep = () => {
    setSteps((prev) => [
      ...prev,
      { action: 'Click', locatorType: 'CSS', locator: '', value: '', description: '', expectedValue: '', notes: '' },
    ])
  }
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-4">
        ...
        <button onClick={addStep} className="inline-flex items-center gap-1.5 rounded-lg bg-pink-50 dark:bg-pink-900/20 px-3 py-1.5 text-xs font-medium text-pink-600 dark:text-pink-400 hover:bg-pink-100 dark:hover:bg-pink-900/30 transition-colors duration-200 cursor-pointer">
